...
function Header() {
    ...
    return (
        <header className="backdrop-blur-2xl fixed w-full bg-custom-bg-secondary px-4 sm:px-6 md:px-16 py-2 flex items-center gap-2 sm:gap-4 md:gap-8 lg:gap-16 shadow-2xs">
        {/* Логотип / название */}
        <a href="/wiki" className={`${styles.logoLink} text-custom-main font-bold text-xl sm:text-2xl whitespace-nowrap`}>
            <span className='sm:hidden'>Wiki</span>
            <span className={`${styles.desktopText} hidden sm:inline`}>СтудБаза Wiki</span>
        </a>
